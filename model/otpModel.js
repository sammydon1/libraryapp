...
export function sendVerificationEmail(email, otp) {
  ...
  let message = {
    ...
    <div style="margin:0px auto;width:70%;padding:20px 0">
      ...
      <p>Thank you for choosing My Library app. Use the following OTP to complete your Sign Up procedures. OTP is valid for 5 minutes</p>
  ...
  transporter
    ...
    .then((success) =>
      console.log(
        "New document saved to the database and email sent to " + email
      )
    )
